...
module.exports = {
  ...
  app: {
    name: "TWS test backend",
    serverURL: envVars.BASE_SERVER_URL,
    apiURL: envVars.BASE_API_URL,
    clientURL: envVars.BASE_CLIENT_URL,
  },
  aws: {
    ...
    sesSenderAddress: "navtej.gill@simbaquartz.com",
  },
  nodemailer: {
